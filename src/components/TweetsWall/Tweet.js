...
const Tweet = ({id, name, username, content }) => {
  return (
    <article className="tweet-container flex">
      <div>
        <p className="tweet-img"></p>
      </div>
      <div className="tweet">
        <div className="tweet-header flex">
          <div className="left-side flex">
            <p>{name}</p>
            <p className="fc-gray">@{username}</p>
            <span  className="fc-gray">·</span>
            <p  className="fc-gray">13min</p>
          </div>
